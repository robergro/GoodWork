	...
	$.pageLoader = function() {
		...
		function chargementTermine() {
			...
			$chargement
				...
				/*$("#videoChargement").css({display:'none'});

				document.getElementById('FirstChargement').removeAttribute('data-video')


				var FirstChargement = document.getElementById('FirstChargement')


            //On met par défaut le profil et on cache les deux autres
            FirstChargement.style.display = FirstChargement.style.display = 'none';*/
